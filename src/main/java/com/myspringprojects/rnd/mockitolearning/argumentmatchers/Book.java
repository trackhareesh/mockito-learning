...
public class Book {
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return price == book.price && isDigital == book.isDigital && Objects.equals(bookId, book.bookId) &&
                Objects.equals(title, book.title) && Objects.equals(publishedDate, book.publishedDate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(bookId, title, price, publishedDate, isDigital);
    }
}
