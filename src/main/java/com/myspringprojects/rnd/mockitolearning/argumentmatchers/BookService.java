...
public class BookService {
    ...
    public void updatePrice(String bookId, int updatedPrice) {
        ...
        // Create a copy of the book here.
        Book newBook = new Book(book.getBookId(), book.getTitle(), book.getPrice(), book.getPublishedDate());

        newBook.setPrice(updatedPrice);
        bookRepository.save(newBook);
    }

    public Book getBookByTitleAndPublishedDate(String title, LocalDate publishedDate) {
        return bookRepository.findByTitleAndPublishedDate(title, publishedDate);
    }

    public Book getBookByTitlePriceAndIsDigital(String title, int price, boolean isDigital) {
